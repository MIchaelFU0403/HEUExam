...
<div class="wrap" id="wrap">
	...
	<div class="logGet">
			...
			<div class="logD logDtip">
				<p class="p1" align="justify" dir="ltr" style=''>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 管理员注册<br></p>
			</div>
			<!-- 输入框 -->
     <form action="${pageContext.request.contextPath}/register.action" method="post">
       ...
       <table bgcolor="AliceBlue" align="center" border="0" width="386" height="563">
          ...
          <tr>
           ...
           <tr align="center"> 
            ...
            <input type="reset"  value="取消" "width:60px; height:30px;"/></td>
          </tr>
       </table>     
     </form>
     </div>
       ...
       <div id="ff">
    <div id="gg" style="top: -231px; left: 603px;">
   
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<a href="/HEUExam/login.jsp">返回登录</a></p>
